...
set TCL_LIBRARY=%RDI_APPROOT%/tps/tcl/tcl8.6
...
rem # https://jira.xilinx.com/browse/VIVADO-3596
rem # set _RDI_NEEDS_PYTHON=True
...
if [%_RDI_NEEDS_PYTHON%] == [True] (
  ...
  set PYTHONPATH=!RDI_LIBDIR!;!PYTHONPATH!
...
if defined RDI_INVOKE_VERSION_ONLY (
  call %PRODVERSION_EXE% %RDI_PROGNAME% -longversion
  exit /b 1
)
